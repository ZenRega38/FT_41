...
export function Timeline() {
  ...
  return (
    <section className="py-24 bg-charcoal relative overflow-x-clip" >
      <Container>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-[1px] bg-glass transform md:-translate-x-1/2">
            <motion.div 
              initial={{ height: 0 }}
              whileInView={{ height: '100%' }}
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 2, ease: "easeInOut" }}
              className="w-full bg-gradient-to-b from-gold via-gold/50 to-transparent origin-top"
            />
          </div>
          ...
          <div className="space-y-12">
            {steps.map((step, idx) => (
              ...
              >
                ...
                {/* Marker */}
                <div className="absolute left-4 md:left-1/2 w-3 h-3 bg-gold rounded-full transform -translate-x-[5px] md:-translate-x-1.5 mt-1.5 md:mt-0 shadow-[0_0_15px_rgba(212,175,55,0.8)] z-10"></div>
