...
export function TransparansiPopup() {
  ...
  useEffect(() => {
    ...
    const hasSeenPopup = localStorage.getItem('ft41_transparansi_dismissed');
    if (!hasSeenPopup) {
  ...
  const handleClose = () => {
    if (rememberMe) {
      localStorage.setItem('ft41_transparansi_dismissed', 'true');
    }
    setIsOpen(false);
  };
        ...
        >
          ...
          >
            ...
            <div className="p-8 md:p-10 text-center space-y-6">
              <div className="mx-auto w-16 h-16 rounded-full bg-black-soft flex items-center justify-center border border-gold/30 mb-6 shadow-[0_0_15px_rgba(212,175,55,0.2)]">
